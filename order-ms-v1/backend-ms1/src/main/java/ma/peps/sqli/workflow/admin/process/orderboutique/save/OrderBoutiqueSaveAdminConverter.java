...
@Component
public class OrderBoutiqueSaveAdminConverter extends AbstractProcessConverter<OrderBoutiqueSaveAdminInput,OrderBoutiqueSaveAdminOutput,OrderBoutique> {
    ...
    public OrderBoutiqueSaveAdminConverter(){
        super(OrderBoutique.class, OrderBoutiqueSaveAdminInput.class, OrderBoutiqueSaveAdminOutput.class);
    }

    @Override
    public OrderBoutique toItem(OrderBoutiqueSaveAdminInput input) {
        if (input == null) {
            return null;
        } else {
    ...
    @Override
    public OrderBoutiqueSaveAdminOutput toOutput(OrderBoutique item) {
        if (item == null) {
            return null;
        } else {
            OrderBoutiqueSaveAdminOutput output = new OrderBoutiqueSaveAdminOutput();
