...
type ProductCategoryEditAdminType = {
    visible: boolean,
    onClose: () => void,
    showToast: React.Ref<Toast>,
    selectedItem: ProductCategoryDto
    update: (item: ProductCategoryDto) => void,
    list: ProductCategoryDto[],
    service: ProductCategoryAdminService,
    t: TFunction
}
const Edit: React.FC<ProductCategoryEditAdminType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
    ...
    const {
        ...
        parseToIsoFormat,
        adaptDate
        } = useEditHook<ProductCategoryDto, ProductCategoryCriteria>({list, selectedItem, onClose, update, showToast,service, t, isFormValid})
